...
const WORDS = ["Web Development","Machine Learning","App Development"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Python","Html","Flutter"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/EkiZR" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/ekizr/" },
  { icon: Instagram, link: "https://www.instagram.com/shrinav._/?hl=id" }
];
